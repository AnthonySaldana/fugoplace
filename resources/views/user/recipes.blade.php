        ...
        if( ( isset( $recipe['videolink'] ) && !empty( $recipe['videolink'] ) ) ){
          ...
          ?>
            <tr>
              ...
              <td class="button"><p class=" button1"><br /><u><strong>Recipe Title:</strong>&nbsp;{{ $title }}</u>&nbsp;&nbsp;&nbsp;<u><strong>Creator Cited:&nbsp;</strong>{{ $author }}</u><br /><br /><br />{!! str_limit( strip_tags( $desc ) , $strlimit, $end = '...' ) !!}<br/>
